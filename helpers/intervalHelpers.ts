...
export function convertCyclicIntervalToSeconds(cyclicInterval: CyclicInterval): number {
...
export function checkIfCyclicInterval(value: CyclicInterval | undefined): boolean | undefined {
